...
public class AdminStatisticsController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        #region İstatistik2
        var responseMessage2 = await client.GetAsync("https://localhost:7167/api/Statistic/GetLocationCount");
        ...
        #region İstatistik3
        var responseMessage3 = await client.GetAsync("https://localhost:7167/api/Statistic/GetAuthorCount");
        ...
        #region İstatistik4
        var responseMessage4 = await client.GetAsync("https://localhost:7167/api/Statistic/GetBlogCount");
        ...
        #region İstatistik5
        var responseMessage5 = await client.GetAsync("https://localhost:7167/api/Statistic/GetBrandCount");
        ...
        #region İstatistik6
        var responseMessage6 = await client.GetAsync("https://localhost:7167/api/Statistic/GetAvgRentPriceForDaily");
        ...
        #region İstatistik7
        var responseMessage7 = await client.GetAsync("https://localhost:7167/api/Statistic/GetAvgRentPriceForWeekly");
        ...
        #region İstatistik8
        var responseMessage8 = await client.GetAsync("https://localhost:7167/api/Statistic/GetAvgRentPriceForMonthly");
        ...
        #region İstatistik9
        var responseMessage9 = await client.GetAsync("https://localhost:7167/api/Statistic/GetCarCountByTranmissionIsAuto");
        ...
        #region İstatistik10
        var responseMessage10 = await client.GetAsync("https://localhost:7167/api/Statistic/GetBrandNameByMaxCar");
        ...
        #region İstatistik11
        var responseMessage11 = await client.GetAsync("https://localhost:7167/api/Statistic/GetBlogTitleByMaxBlogComment");
        ...
        #region İstatistik12
        var responseMessage12 = await client.GetAsync("https://localhost:7167/api/Statistic/GetCarCountByKmSmallerThen1000");
        ...
        #region İstatistik13
        var responseMessage13 = await client.GetAsync("https://localhost:7167/api/Statistic/GetCarCountByFuelGasolineOrDiesel");
        ...
        #region İstatistik14
        var responseMessage14 = await client.GetAsync("https://localhost:7167/api/Statistic/GetCarCountByFuelElectric");
        ...
        #region İstatistik15
        var responseMessage15 = await client.GetAsync("https://localhost:7167/api/Statistic/GetCarBrandAndModelByRentPriceDailyMax");
        ...
        #region İstatistik16
        var responseMessage16 = await client.GetAsync("https://localhost:7167/api/Statistic/GetCarBrandAndModelByRentPriceDailyMin");
