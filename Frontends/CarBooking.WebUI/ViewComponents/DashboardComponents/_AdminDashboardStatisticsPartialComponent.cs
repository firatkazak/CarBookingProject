...
public class _AdminDashboardStatisticsPartialComponent : ViewComponent
{
    private readonly IHttpClientFactory _httpClientFactory;
    public _AdminDashboardStatisticsPartialComponent(IHttpClientFactory httpClientFactory)
    {
    ...
    public async Task<IViewComponentResult> InvokeAsync()
    {
        ...
        #region İstatistik3
        var responseMessage3 = await client.GetAsync("https://localhost:7167/api/Statistic/GetBrandCount");
        ...
        #region İstatistik4
        var responseMessage4 = await client.GetAsync("https://localhost:7167/api/Statistic/GetAvgRentPriceForDaily");
